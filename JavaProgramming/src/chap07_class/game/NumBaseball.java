...
//				com[i] = (int)(Math.random()*10);
//			}
//			if(isDuplicated(com) == false) {
//				System.out.println("답 : " + com[0] + ", " + com[1] + ", " + com[2]);
//				break;
//			}
//		}
		
		//3스트라이크 아웃이 될 때까지 사용자의 입력값 받기
		while(true) {
...
//	public boolean isDuplicated(int[] intArr) {
...
//	}
//	
//	public void ballAndStrike(int[] com, int[] user) {
//		for(int i = 0 ; i < com.length ; i++) {
