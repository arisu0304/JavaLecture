...
public class _01_Instance {
	...
	public static void main(String[] args) {
		...
		// 인스턴스하를 진행하게 되면 클래스 내의 선언된 변수들과 메소드들이 메모리에 올라가고
		// 그 변수들과 메소드를 사용할 수 있는 클래스 타입의 값이 객체로 하나 만들어지게 된다.
		// 인스턴스화 방식 : new 키워드 + 생성자();
		...
		// 인스턴스(객체)를 생성해서 새로운 메모리 공간에 할당받기 때문에 car와 car2는 
		// 서로 영향을 주지 않는다.
		Car car2 = new Car();
...
//		// generateCar 실행하면서 주소 새롭게 할당
//		car2 = generateCar(car);
//		System.out.println(car2);
//		System.out.println(car == car2);
//		System.out.println(car2.company);
...
//		car.printCarInfo();
	...
	// 클래스는 타입의 역할도 하기 때문에 메소드의 리턴타입니다 매개변수로도 사용할 수 있다.
