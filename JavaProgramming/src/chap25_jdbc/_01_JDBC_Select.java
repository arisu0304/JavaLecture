...
public class _01_JDBC_Select {
    ...
    public static void main(String[] args) {
        ...
        // 오라클 jdbc:oracle:thin:@호스트ip:포트:sid
        // mysql jdbc:mysql://호스트ip:포트/스키마명
        // localhost 대신 127.0.0.1도 가능 
        ...
        try{
            ...
            // 8. 실행 시킬 쿼리를 문자열로 작성
            String selectStudentInfo = "SELECT ST.SNO ,ST.SNAME ,ROUND(AVG(SC.RESULT), 2) AS AVG_RES"
            ...
            while(rs.next()) {
                // 11. ResultSet 에서 각각의 타입에 맞게 값을 꺼낸다.
                // 문자열은 getString 메소드, 정수형은 getInteger 메소드,
                // 실수형은 getDouble 메소드
                String sno = rs.getString("sno");
                String sname = rs.getString("sname");
                double avgRes = rs.getDouble("avg_res");

                System.out.println("학번 : " + sno + ", 이름:" +
                        ", 기말교사 평균점수: " + avgRes);
            }
